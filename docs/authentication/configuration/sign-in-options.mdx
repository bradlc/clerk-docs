...
description: Test! Clerk provides a large selection of options for managing your user's sign-in experience.
---
...
If your initial sign-in choices aren't working out or if you want to add more options for your users, you can make changes by navigating to the Clerk Dashboard and opening the **User & Authentication** drop down. From there, you can make changes to the necessary settings. For example, if you decide you would like to add GitHub as a social login provider, you can do so by navigating to the [**Social Connections**](https://dashboard.clerk.com/last-active?path=user-authentication/social-connections) page and toggling on the GitHub provider.
